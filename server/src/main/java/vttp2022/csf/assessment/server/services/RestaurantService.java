...
public class RestaurantService {
	...
	public String getValsFromLatLon(LatLng latLng) {
		String results = "[%s, %s]".formatted(latLng.getLongitude(), latLng.getLatitude());
	...
	public Optional<Restaurant> getRestaurant(String restaurantId) {
		...
		// set map URL if restaurant exists
		r.setMapURL(mapCache.getMap(r));
